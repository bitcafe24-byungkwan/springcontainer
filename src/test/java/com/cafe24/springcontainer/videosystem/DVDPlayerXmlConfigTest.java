...
public class DVDPlayerXmlConfigTest {
	...
	public void testDVD7() {
		...
		assertEquals("BlankDisc [title=Avengers Director`s Edition, studio=MARVEL, actors=[Scarlett Johansson, Jeremy Renner, Chris Evans]]",
	...
	public void testDVD8() {
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack 1, studio=MARVEL, actors=[Scarlett Johansson, Jeremy Renner, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}	
	@Test
	public void testDVD9() {
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack 2, studio=MARVEL, actors=[Scarlett Johansson, Jeremy Renner, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}		
	@Test
	public void testDVD10() {
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack 3, studio=MARVEL, actors=[Scarlett Johansson, Jeremy Renner, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}	
